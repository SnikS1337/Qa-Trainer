      ...
      <div className="min-h-screen text-white font-sans selection:bg-brand-purple/30 relative overflow-x-hidden">
        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          <AnimatePresence mode="wait">
            ...
            {(screen === 'practice_task' || screen === 'practice-task') && <motion.div key="practice_task" initial={{ opacity: 0, y: 14, scale: 0.994 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: -10, scale: 0.996 }} transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }} className="screen-shell flex-1 flex"><PracticeTask id={currentId!} /></motion.div>}
